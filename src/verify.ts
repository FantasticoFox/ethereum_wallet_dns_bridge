...
export async function verifyProof(domain: string, lookupKey: string): Promise<boolean> {
  ...
  totalTests++;
  console.log(`Test 1/6: DNS Record Existence`);
  ...
  try {
    ...
    totalTests++;
    console.log(`\nTest 4/6: Domain Consistency & EIP-191 Message Reconstruction`);
    ...
    totalTests++;
    console.log(`\nTest 6/6: Cryptographic Signature Verification (EIP-191 Compliant)`);
